        ...
        <div className="space-y-6">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Slash commands for server staff and members, including permission requirements and examples.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                ...
                return (
                    <Card key={category}>
                        ...
                        <CardContent className="space-y-4">
                            {entries.map((command) => (
                                <div key={command.command} id={toCommandAnchor(command.command)} className="scroll-mt-24 rounded-md border p-4">
